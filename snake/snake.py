...
def draw_snake(snake):
    for i, pos in enumerate(snake):
        ...
        if i == 0:
            pygame.draw.rect(screen, (0, 255, 120), (x, y, block, block), border_radius=8)
            pygame.draw.circle(screen, (0, 0, 0), (x+5, y+6), 3)
            pygame.draw.circle(screen, (0, 0, 0), (x+15, y+6), 3)
        else:
            pygame.draw.rect(screen, (0, 180, 0), (x, y, block, block), border_radius=6)
...
while running:
        ...
        if event.type == pygame.KEYDOWN:
            ...
            if state == "WELCOME":
                ...
                state, snake, direction, food, score = handle_pause_events(
                    event, state, snake, direction, food, score, reset_game
                )
    ...
    if state == "WELCOME":
        ...
        pygame.draw.circle(screen, RED, (food[0] + block//2, food[1] + block//2), block//2)
